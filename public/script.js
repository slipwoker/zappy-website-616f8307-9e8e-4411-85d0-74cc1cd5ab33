  ...
  if (contactForm) {
    ...
    function validateField(input) {
      ...
      if (value && minLength && value.length < parseInt(minLength)) {
        showError(input, input.getAttribute('data-error-minlength') || 'Minimum ' + minLength + ' characters required');
        return false;
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '616f8307-9e8e-4411-85d0-74cc1cd5ab33',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '616f8307-9e8e-4411-85d0-74cc1cd5ab33';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '616f8307-9e8e-4411-85d0-74cc1cd5ab33';
